...
UPDATE configuration SET maxspeed_urban = CASE
    ...
    WHEN tag_value = 'trunk'             THEN 40 -- Lake Shore Driver, major highways
    WHEN tag_value = 'trunk_link'        THEN 30 -- 
    WHEN tag_value = 'primary'           THEN 20 -- Commerical strips w/ stoplights.
    WHEN tag_value = 'primary_link'      THEN 12 -- 
    ...
    WHEN tag_value = 'tertiary_link'     THEN 35
